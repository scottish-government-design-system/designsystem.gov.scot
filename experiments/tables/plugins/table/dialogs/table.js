                ...
                elements: [ {
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                type: 'select',
                                id: 'smallScreenBehaviour',
                                requiredContent: 'table[data-smallscreen]',
                                label: 'Small screen behaviour',
                                'default': '',
                                items: [
                                    [ 'None', '' ],
                                    [ 'Boxes', 'boxes' ],
                                ...
                                setup: function( selectedTable ) {
                                    this.setValue( selectedTable.getAttribute( 'data-smallscreen' ) || '' );
                                },
                                commit: function( data, selectedTable ) {
                                    if ( this.getValue() )
                                        selectedTable.setAttribute( 'data-smallscreen', this.getValue() );
                                    else
                                        selectedTable.removeAttribute( 'data-smallscreen' );
                                }
                            }
